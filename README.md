...
전자의 예시인 동방화영총, 트윙클 스타 스프라이트 등의 게임에서는 둘이서 대전한다는 느낌이 들지 않습니다. 이런 게임들에서는 상대방의 움직임을 제한하는 식으로 공격이 이루어지는데, 이러한 특성상 상대방의 패턴을 피하거나, 혹은 상대방을 직접 공격한다는 느낌을 받기는 어렵습니다.    
